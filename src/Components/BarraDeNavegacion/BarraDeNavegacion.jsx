        ...
        <div className='contenedorNavbarPrincipal'>
            <nav className='navbarPrincipal'>
                ...
                <div className='contenedorBotonesNavbar'>
                    <ul>
                        <a href="/" className={`linkNavbar ${ props.activePage === 'home' && 'linkNavbarActive'}`}>
                            <li>
                        ...
                        <a href="/pacientes" className={`linkNavbar ${ props.activePage === 'pacientes' && 'linkNavbarActive'}`}>
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="18" viewBox="0 0 17 18" fill="none">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M11.1268 8.83701C12.3194 7.94141 13.0908 6.51534 13.0908 4.90909C13.0908 2.19787 10.8929 0 8.1817 0C5.47048 0 3.27261 2.19787 3.27261 4.90909C3.27261 6.51538 4.04408 7.94148 5.23672 8.83708C2.17322 10.2559 0 13.8234 0 18V18H16.3636V18C16.3636 13.8233 14.1903 10.2558 11.1268 8.83701Z"/>
                                </svg>
                                <span>Pacientes</span>
                            </li>
                        </a>
                        <a href="/" className={`linkNavbar ${ props.activePage === 'asd' && 'linkNavbarActive'}`}>
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="18" viewBox="0 0 15 18" fill="none">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M0 1C0 0.447716 0.447715 0 1 0H14.0001C14.5524 0 15.0001 0.447715 15.0001 1V17.0001C15.0001 17.5524 14.5524 18.0001 14.0001 18.0001H1C0.447715 18.0001 0 17.5524 0 17.0001V1ZM2.99993 2.99994H12V4.49995H2.99993V2.99994ZM12 6H2.99993V7.50001H12V6ZM2.99993 9H12V10.5H2.99993V9ZM9.0001 12H6.00007V13.5H9.0001V12Z"/>
                                </svg>
                                <span>Turnos</span>
                            </li>
                        </a>
